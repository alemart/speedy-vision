...
export function convolution(kernel, normalizationConstant = 1.0)
{
    ...
    if(kSize < 1 || kSize % 2 == 0)
        Utils.fatal(`Can't perform a convolution with an invalid kSize of ${kSize}`);
    else if(kSize * kSize != kernel32.length)
        Utils.fatal(`Invalid convolution kernel of ${kernel32.length} elements (expected: square)`);
