...
void main()
{
    ...
    if(patchRadius >= 1) {
        ...
        p[0] = vec4(
            pixelAtOffset(image, ivec2(0, -1)).g,
            pixelAtOffset(image, ivec2(1, -1)).g,
            pixelAtOffset(image, ivec2(1, 0)).g,
            pixelAtOffset(image, ivec2(1, 1)).g
        );
        p[1] = vec4(
            pixelAtOffset(image, ivec2(0, 1)).g,
        ...
        if(patchRadius >= 2) {
            p[0] = vec4(
                pixelAtOffset(image, ivec2(0, -2)).g,
                pixelAtOffset(image, ivec2(1, -2)).g,
                pixelAtOffset(image, ivec2(2, -1)).g,
                pixelAtOffset(image, ivec2(2, 0)).g
            );
            p[1] = vec4(
                pixelAtOffset(image, ivec2(2, 1)).g,
                pixelAtOffset(image, ivec2(1, 2)).g,
