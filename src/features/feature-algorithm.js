 ...
 */
export /* abstract */ class FeatureAlgorithm
{
    /**
     * Class constructor
     * @param {SpeedyGPU} gpu
    ...
    {
        this._gpu = gpu;
        this._downloader = new FeatureDownloader(this._gpu, this.descriptorSize);
        this._sensitivity = 0;
     ...
     * @returns {AutomaticSensitivity}
     */
    get automaticSensitivity()
    {
        // lazy instantiation
        ...
        return this._automaticSensitivity;
    }
